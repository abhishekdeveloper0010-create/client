...
function Checkout() {
  ...
  const placeOrder = (event) => {
    ...
    if (paymentMethod === "upi" && !paymentDetails.upiId) {
      setPaymentMessage("Please enter your UPI ID before placing the order.");
      return;
    }
    ...
    const paymentInfo =
      paymentMethod === "card"
        ...
        : paymentMethod === "upi"
          ...
          : {
              codNote: paymentDetails.codNote || "Pay at delivery",
            };

    setPaymentMessage(`Payment selected: ${methodLabel}`);
            ...
            <div className="w-full rounded-3xl bg-white p-4 shadow-sm sm:p-6 lg:col-span-2 lg:p-8">
              ...
              {cart.length === 0 ? (
                <div className="rounded-3xl border border-dashed border-gray-300 p-6 text-center sm:p-8">
                  <p className="text-lg text-gray-500 sm:text-xl pb-5">
                ...
                <form onSubmit={placeOrder} className="space-y-6">
                  ...
                  {/* Address */}
                  <label className="block">
                    <span className="text-sm font-semibold text-gray-600 pb-4">
                      Address
                    </span>
                  ...
                  <div className="rounded-3xl bg-slate-50 p-4 sm:p-5">
                    ...
                    {paymentMethod === "card" && (
                      <div className="pt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <label className="block text-sm text-gray-600">
                          <span className="mb-2 block font-semibold">CVV</span>
                    ...
                    {/* UPI Payment */}
                    {paymentMethod === "upi" && (
                      <label className="pt-4 block text-sm text-gray-600">
                        <span className="mb-2 block font-semibold">UPI ID</span>
