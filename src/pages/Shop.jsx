      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16">
        ...
        <div
          className="
            ...
            xl:grid-cols-5 xl:gap-x-10
            2xl:grid-cols-6 2xl:gap-x-12
          "
        >
          {categories.map((item) => (
            <button
              ...
              className={`flex w-full flex-col items-center text-center rounded-3xl border p-4 transition duration-300 ${
